...
/**
 * HTTP smoke test for ProjectController. The configured route group
 ...
 * @internal
 */
final class ProjectControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/newsletter/projects');
    ...
    {
        $result = $this->get('/api/v1/newsletter/projects/99999');
