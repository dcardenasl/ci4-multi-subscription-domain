...
/**
 * HTTP smoke test for CampaignController. The configured route group
 ...
 * @internal
 */
final class CampaignControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/newsletter/campaigns');
    ...
    {
        $result = $this->get('/api/v1/newsletter/campaigns/99999');
