...
/**
 * HTTP smoke test for SubscriberController. The configured route group
 ...
 * @internal
 */
final class SubscriberControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/newsletter/subscribers');
    ...
    {
        $result = $this->get('/api/v1/newsletter/subscribers/99999');
    ...
    {
        $result = $this->delete('/api/v1/newsletter/subscribers/99999');
