...
/**
 * HTTP smoke test for EmailTemplateController. The configured route group
 ...
 * @internal
 */
final class EmailTemplateControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/newsletter/email-templates');
    ...
    {
        $result = $this->get('/api/v1/newsletter/email-templates/99999');
