...
#[OA\Schema(schema: 'CampaignIndexRequest')]
readonly class CampaignIndexRequestDTO extends BaseRequestDTO
{
    public int $page;
    public int $per_page;
    ...
    #[OA\Property(description: 'Filter by status', type: 'string', nullable: true, enum: ['draft', 'scheduled', 'sending', 'sent', 'cancelled'])]
    ...
    public function rules(): array
    {
        return [
            ...
            'status'     => 'permit_empty|in_list[draft,scheduled,sending,sent,cancelled]',
