# TASKS — ci4-multi-subscription-domain
...
- **Por qué**: el scaffolder emite `boolean_like` para fields `bool`, pero `ci4-multi-subscription-domain` no exponía esa regla. Eso rompía CRUDs generados con booleanos y obligaba a parchear DTOs/modelos a mano.
